...
export interface Repository {
	...
	writeEditorConfig(formatter: Formatters, linter: Linters, techs: string[]): Promise<void>

	writePackageJsonScripts(formatter: Formatters, linter: Linters): Promise<void>
	getEditorExtensions(formatter: Formatters, linter: Linters): Promise<{ name: string; vsc: string; vsx: string }[]>
